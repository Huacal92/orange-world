			...
			tpj(document).ready(function() {
				if(tpj("#rev_slider_1").revolution == undefined){
					...
					tpj("#rev_slider_1").show().revolution({
						sliderType:"standard",
						jsFileLocation:"views/plugins/revolution/js/",
...
toggleSearch.addEventListener('click', function() {
    ...
    document.querySelector('.h-search-form-inner > form > input.search-field');
    /* searchInput.focus(); */
});
